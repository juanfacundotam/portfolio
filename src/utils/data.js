...
const data = [
    {
      ...
      description: "En colaboración con el equipo de la startup europea Social Media Lab IA, desarrollamos una plataforma de gestión para empleados. Me involucré activamente en el desarrollo, abarcando tanto el frontend como el backend, así como la configuración de la base de datos. Juntos, logramos crear una solución integral que cumple con los objetivos y requisitos de la startup. A través del botón Sitio Web se ingresa a un video que realicé para la presentación de la app.",
      image: "foto1",
